...
return array(
	...
	'params'      => array(
		...
		array(
			...
			'description' => esc_html__( 'Size of the decorative icon (e.g., 80px or 4vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '40px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Font size for the quote text (e.g., 40px or 2vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '1604px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Maximum width of the content area (e.g., 1604px).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '22px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Font size for the attribution name (e.g., 22px or 1.5vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Fixed height for the entire section (e.g., 500px or 60vh). Content is vertically centered. Leave empty to auto-size to the tallest quote.', 'cph-elements' ),
		),
		...
		array(
			...
			'description' => esc_html__( 'Space between icon and quote (e.g., 10px or 1vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '20px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Space between quote and attribution (e.g., 20px or 1vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'description' => esc_html__( 'Space above the button (e.g., 30px or 2vw).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '18px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Size of the navigation dots (e.g., 18px).', 'cph-elements' ),
		),
		...
		array(
			...
			'value'       => '12px',
			'group'       => esc_html__( 'Style', 'cph-elements' ),
			'description' => esc_html__( 'Space between dots (e.g., 12px).', 'cph-elements' ),
		),
